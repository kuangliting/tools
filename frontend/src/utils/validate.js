...
const _isDomainRegExp = new RegExp("^(?!-)[A-Za-z0-9-]+([\\-\\.]{1}[a-z0-9]+)*\\.[A-Za-z]{2,6}$")
export function isDomain(str) {
  return _isDomainRegExp.test(str)
}
export function isDecimalIp(str) {
...
export function UrlValidatorCreator(errInfo) {
