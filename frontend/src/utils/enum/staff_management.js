...
export const StaffInfoChangeTypeMap = {
  [StaffInfoChangeType.ADD]: '新增',
  [StaffInfoChangeType.UPDATE]: '更新',
  [StaffInfoChangeType.DELETE]: '删除',
  [StaffInfoChangeType.CLEAR]: '清空'
};
export const StaffInfoChangeTypeList = [{
  label: '新增',
  value: StaffInfoChangeType.ADD
}, {
  label: '更新',
  value: StaffInfoChangeType.UPDATE
}, {
  label: '删除',
  value: StaffInfoChangeType.DELETE
}, {
  label: '清空',
  value: StaffInfoChangeType.CLEAR
}];