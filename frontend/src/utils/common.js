...
export const ImgFileTypeMap = {
  [ImgFileType.JPG_TYPE]: 'JPG 文件',
  [ImgFileType.PNG_TYPE]: 'PNG 文件',
  [ImgFileType.BMP_TYPE]: 'BMP 文件',
  [ImgFileType.INVALID_TYPE]: '非法图像文件'
};
export const ImgFileTypeList = [{
  label: 'JPG 文件',
  value: ImgFileType.JPG_TYPE
}, {
  label: 'PNG 文件',
  value: ImgFileType.PNG_TYPE
}, {
  label: 'BMP 文件',
  value: ImgFileType.BMP_TYPE
}, {
  label: '非法图像文件',
  value: ImgFileType.INVALID_TYPE
}];
export const Gender = {
  FEMALE: 0,
  MALE: 1
...
export const StaffTypeMap = {
  [StaffType.STAFF_LIST_TYPE_WHITE]: '白名单',
  [StaffType.STAFF_LIST_TYPE_BLACK]: '黑名单',
  [StaffType.STAFF_LIST_TYPE_INVAILID]: '无效类型'
};
export const StaffTypeList = [{
  label: '白名单',
  value: StaffType.STAFF_LIST_TYPE_WHITE
}, {
  label: '黑名单',
  value: StaffType.STAFF_LIST_TYPE_BLACK
}, {
  label: '无效类型',
  value: StaffType.STAFF_LIST_TYPE_INVAILID
}];
...
export const ScreenSplitTypeMap = {
  [ScreenSplitType.SCREEN_SPLIT_TYPE_ONE]: '一分屏',
  [ScreenSplitType.SCREEN_SPLIT_TYPE_FOUR]: '四分屏',
  [ScreenSplitType.SCREEN_SPLIT_TYPE_FULL]: '全屏'
};
export const ScreenSplitTypeList = [{
  label: '一分屏',
  value: ScreenSplitType.SCREEN_SPLIT_TYPE_ONE
}, {
  label: '四分屏',
  value: ScreenSplitType.SCREEN_SPLIT_TYPE_FOUR
}, {
  label: '全屏',
  value: ScreenSplitType.SCREEN_SPLIT_TYPE_FULL
}];
...
export const StreamStatusMap = {
  [StreamStatus.STREAM_STATUS_NONE]: '暂无视频',
  [StreamStatus.STREAM_STATUS_LOADING_FAILED]: '加载失败',
  [StreamStatus.STREAM_STATUS_LOADING]: '加载中',
  [StreamStatus.STREAM_STATUS_PLAYING]: '播放展示状态'
};
export const StreamStatusList = [{
  label: '暂无视频',
  value: StreamStatus.STREAM_STATUS_NONE
}, {
  label: '加载失败',
  value: StreamStatus.STREAM_STATUS_LOADING_FAILED
}, {
  label: '加载中',
  value: StreamStatus.STREAM_STATUS_LOADING
}, {
  label: '播放展示状态',
  value: StreamStatus.STREAM_STATUS_PLAYING
}];
...
export const StaffLabelTypeMap = {
  [StaffLabelType.INPUT_BOX]: '输入框',
  [StaffLabelType.COMBO_BOX]: '下拉框'
};
export const StaffLabelTypeList = [{
  label: '输入框',
  value: StaffLabelType.INPUT_BOX
}, {
  label: '下拉框',
  value: StaffLabelType.COMBO_BOX
}];
...
export const RecogTypeMap = {
  [RecogType.ANY_TYPE]: '全部',
  [RecogType.WHITELIST_ONLY]: '白名单',
  [RecogType.BLACKLIST_ONLY]: '黑名单',
  [RecogType.NOT_RECOGNIZED]: '陌生人'
};
export const RecogTypeList = [{
  label: '全部',
  value: RecogType.ANY_TYPE
}, {
  label: '白名单',
  value: RecogType.WHITELIST_ONLY
}, {
  label: '黑名单',
  value: RecogType.BLACKLIST_ONLY
}, {
  label: '陌生人',
  value: RecogType.NOT_RECOGNIZED
}];